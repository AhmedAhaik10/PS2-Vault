...
- Store and refresh game data in a lightweight cloud-based repository
...
`IGDB API → n8n workflow → Google Sheets → Power BI dashboard`
...
- The average critic count is **6.98**
